...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(' godspowerojini8@gmail.com');
    setHasCopied(true);
        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">I&apos;m based in Lagos, & Enugu Nigeria and open to remote work worldwide.</p>
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">godspowerojini8@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
